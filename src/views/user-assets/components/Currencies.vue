<template>
  <div v-loading="tableLoading">
    <search-bar
      ...
      :keyWordPlaceholder="'Enter Token Code / Token Name'"
    >
    ...
    >
      <template v-slot:disabledAmount="{row}">
        <span v-if="row.certType === 'Digital Currency'">--</span>
...
import { tradeOrdeAddresses, tradeBalanceListCurrency } from '@/api/user-assets';
