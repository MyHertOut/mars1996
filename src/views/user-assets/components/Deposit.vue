  ...
  <div v-loading="tableLoading">
    ...
    >
      ...
      <!-- <template v-slot:edit="{row}">
        <span @click="browserTxIdUrl(row)" style="color:#214285;cursor: pointer;">Details</span>
      </template> -->
    </element-table>
  </div>
</template>
...
import { tradeOrdeAddresses, balanceListInTransfer } from '@/api/user-assets';
