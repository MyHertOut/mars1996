<template>
  <div class="view-item">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8"><div class="grid-content">{{ detailData.couponPeriods }}</div></el-col>
    ...
    <el-row :gutter="20">
      <el-col :span="4"><div class="sub-title">Maturity Date：</div></el-col>
      <el-col :span="8"><div class="grid-content">{{ detailData.maturityDate | dateFormat }}</div></el-col>
      <el-col :span="4"><div class="sub-title">Redemption Date：</div></el-col>
      <el-col :span="6"><div class="grid-content">{{ detailData.redemptionDate | dateFormat }}</div></el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="4"><div class="sub-title">Disbursement Token：</div></el-col>
      <el-col :span="8"><div class="grid-content">{{ detailData.disburseCode }}</div></el-col>
      <el-col :span="4"><div class="sub-title">Callable Bond：</div></el-col>
      <el-col :span="6"><div class="grid-content">{{ detailData.callable }}</div></el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="5"><div class="sub-title">Coupon Payment Dates：</div></el-col>
    </el-row>
    <template>
