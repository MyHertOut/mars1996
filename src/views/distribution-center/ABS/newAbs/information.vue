  ...
  <div class="information" v-loading="loading">
    <el-form :model="ruleForm" ref="ruleForm" label-width="210px"
      ...
      <el-form-item label="Issuance Address：" prop="issuanceAddress">
        <el-select v-model="ruleForm.issuanceAddress">
          <el-option
      ...
      <el-form-item label="Issuance Quantity：" prop="issuanceQuantity">
        <el-input v-model="ruleForm.issuanceQuantity" maxlength="42" placeholder="Enter the issuance quantity"></el-input>
      </el-form-item>
      <el-form-item label="Par Value Per Token：" prop="parValuePerToken">
        <el-input v-model="ruleForm.parValuePerToken" style="width: 236px;margin-right: 12px;" placeholder="Enter the par value per unit" maxlength="42"></el-input>
      ...
      <el-form-item
        label="Terms & Conditions：" prop="acknowledgeTc">
    ...
    <div class="form-btns">
      <el-button @click="$router.push({ name: 'DisIssueAbsParameters',
        query: {
  ...
  methods: {
    async getBeforeInfo () {
      if (this.$route.query.serialNo) {
        this.loading = true;
        const finData = await getAbsInfo({
        ...
        if (code === '1000') {
          ...
          // this.ruleForm.tcStatus = !!resData.acknowledgeTc;
    ...
    handleNext () {
      this.$refs.ruleForm.validate(async valid => {
        ...
        if (valid && tempValid) {
          ...
          // const settlementToken = params.settlementMethod === '1' ? `1,${params.currency},${params.settlementTokenInput}` : `0,${params.settlementTokenInput}`;
          ...
          if (code === '1000') {
            this.$router.push({ name: 'DisIssueAbsPayment', query: { serialNo: params.serialNo } });
          }
          this.loading = false;
        }
      });
