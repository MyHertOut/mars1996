<template>
    ...
    <div class="view-content" v-loading="loading">
      ...
      <div class="view-item">
        ...
        <el-row :gutter="20">
          <el-col :span="5" v-if="detailData.code"><div class="sub-title">Security Code：</div></el-col>
          <el-col :span="7" v-if="detailData.code"><div class="grid-content">{{detailData.code}}</div></el-col>
          <el-col :span="5" v-if="detailData.name"><div class="sub-title">Security Name：</div></el-col>
          <el-col :span="7" v-if="detailData.name"><div class="grid-content">{{detailData.name}}</div></el-col>
        </el-row>
        <el-row :gutter="20">
          ...
          <el-col :span="5" v-if="detailData.uniqueIdentifierCode"><div class="sub-title">Unique Identifier Code：</div></el-col>
          <el-col :span="7" v-if="detailData.uniqueIdentifierCode"><div class="grid-content">{{detailData.uniqueIdentifierCode.split(',').join('、')}}</div></el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="5" v-if="detailData.issuanceAddress"><div class="sub-title">Issuance Address：</div></el-col>
          <el-col :span="7" v-if="detailData.issuanceAddress">
            <div class="grid-content">
              <a class="link-txt" :href="browserUrlAddress(detailData.issuanceAddress)" target="_blank">{{detailData.issuanceAddress}}</a>
            </div>
          </el-col>
          <el-col :span="5" v-if="detailData.issuanceQuantity"><div class="sub-title">Issuance Quantity：</div></el-col>
          <el-col :span="7" v-if="detailData.issuanceQuantity"><div class="grid-content">{{detailData.issuanceQuantity | demicrometer}}</div></el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="5" v-if="detailData.parValuePerToken"><div class="sub-title">Par Value Per Unit：</div></el-col>
          <el-col :span="7" v-if="detailData.parValuePerToken"><div class="grid-content">{{detailData.parValuePerToken | demicrometer}}</div></el-col>
          <el-col :span="5" v-if="detailData.currency"><div class="sub-title">Currency：</div></el-col>
          <el-col :span="7" v-if="detailData.currency"><div class="grid-content">{{detailData.currency}}</div></el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="5" v-if="detailData.settlementCode"><div class="sub-title">Settlement Token：</div></el-col>
          <!-- v-if="detailData.settlementToken" -->
          <el-col :span="7" v-if="detailData.settlementCode">
            <div class="grid-content">
                {{detailData.settlementCode }}
                <!-- {{settlementTokenDesc(detailData.settlementToken, 'info')}} -->
            </div>
          </el-col>
          <el-col :span="5" v-if="detailData.dayCountConvention"><div class="sub-title">Day Count Convention：</div></el-col>
          <el-col :span="7" v-if="detailData.dayCountConvention"><div class="grid-content">{{dayCountConventionList.filter(v => v.value === detailData.dayCountConvention)[0].label}}</div></el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="5" v-if="detailData.couponFrequency"><div class="sub-title">Coupon Frequency：</div></el-col>
          <el-col :span="7" v-if="detailData.couponFrequency">
          ...
          <el-col :span="5" v-if="detailData.firstSettlementDate"><div class="sub-title">First Settlement Date：</div></el-col>
          <el-col :span="7" v-if="detailData.firstSettlementDate"><div class="grid-content">{{detailData.firstSettlementDate | dateFormat}}</div></el-col>
        </el-row>
        <!-- <el-row :gutter="20">
          <el-col :span="5" v-if="detailData.maturityDate"><div class="sub-title">Maturity Date：</div></el-col>
          <el-col :span="7" v-if="detailData.maturityDate"><div class="grid-content">{{detailData.maturityDate | dateFormat}}</div></el-col>
          <el-col :span="5" v-if="detailData.redemptionDate"><div class="sub-title">Redemption Date：</div></el-col>
          <el-col :span="7" v-if="detailData.redemptionDate"><div class="grid-content">{{detailData.redemptionDate | dateFormat}}</div></el-col>
        </el-row> -->
        <el-row :gutter="20">
          <el-col :span="5"><div class="sub-title">Disbursement Token：</div></el-col>
          <el-col :span="7"><div class="grid-content">{{detailData.disbursementCode }}</div></el-col>
          <!-- <el-col :span="5"><div class="sub-title">Call Date(s)：</div></el-col>
          <el-col :span="7"><div class="grid-content">{{ (detailData.callDateList && detailData.callDateList.length) ? 'Callable' : '--'}}</div></el-col> -->
        </el-row>
        ...
        <el-row :gutter="20" v-if="detailData.couponPeriods">
          <el-col :span="5"><div class="sub-title">Coupon Payment Date：</div></el-col>
        </el-row>
        ...
        <p class="head-title" v-if="detailData.privateDocs || detailData.publicDocs">Docs</p>
        <el-row :gutter="20" v-if="detailData.privateDocs">
        ...
        <el-row :gutter="20" v-if="detailData.publicDocs">
        ...
        <div class="form-btns" v-if="$route.query.type === 'Review'">
          <el-button @click="$router.push({ name: 'DisIssueAbsRrestrictions' })">Previous</el-button>
          <el-button type="primary">Next</el-button>
        </div>
        <div class="form-btns" v-if="$route.query.state === undefined">
          <el-button @click="$router.push({ name: 'DisIssueAbsRrestrictions', query: { serialNo: $route.query.serialNo} })">Previous</el-button>
  ...
  methods: {
    ...
    async getDetail () {
      ...
      if (data.code === '1000') {
        ...
        if (this.detailData.privateDocs) {
          this.documentPrivacyList = this.detailData.privateDocs;
          this.documentPrivacyList.forEach(v => {
            v.src = '/v1/asset/file/readFile?id=' + v.id;
          });
        }
        if (this.detailData.publicDocs) {
          this.documentPublicList = this.detailData.publicDocs; // JSON.parse(this.detailData.publicFile);
    ...
    async getStepDetail () {
      ...
      if (code === '1000') {
        ...
        if (this.detailData.publicDocs) {
          this.documentPublicList = this.detailData.publicDocs;
          this.documentPublicList.forEach(v => {
            v.src = '/v1/asset/file/readFile?id=' + v.id;
          });
        }
