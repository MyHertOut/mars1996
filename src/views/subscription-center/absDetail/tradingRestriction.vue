  ...
  methods: {
    async getInfo () {
      ...
      if (data.data.individual) {
        this.individualPermitted = data.data.individual.filter(v => v.permitted === 1);
        this.individualProhibited = data.data.individual.filter(v => v.permitted === 2);
      ...
      if (data.data.institutional) {
        this.institutionalPermitted = data.data.institutional.filter(v => v.permitted === 1);
        this.institutionalProhibited = data.data.institutional.filter(v => v.permitted === 2);
