    ...
    <div class="view-content main-container" v-loading="loading">
      ...
      <div class="view-item">
        ...
        <div class="return-btn">
          <el-button
            type="primary"
            @click="$router.push({ name: 'AssetServicingRedemption', query: { code: $route.query.code } })"
          >Return</el-button>
        </div>
      </div>
    </div>
...
import { redeemBatchList, redeemBatchDetail } from '@/api/common.js';
    ...
    return {
      ...
      breadData: [{
        ...
        to: {
          ...
          query: { code: this.$route.query.code, t: this.$route.query.t }
        }
        // to: '/asset-servicing/redemption'
      }, {
        name: 'Details'
      }],
      tableData: [],
